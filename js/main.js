...
function renderLoop() {
  ...
  if (analyzer && musicIsPlaying) {
    ...
    const { beat, strong: strongBeat, strength: beatStrength } = beatDetector.update(features.bass);
    ...
    const { beat: fluxBeat, strong: fluxStrongBeat, strength: fluxStrength } = fluxBeatDetector.update(flux);
