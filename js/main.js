...
customCharacterFileInput.addEventListener("change", () => {
  ...
  CHARACTERS.custom = {
    ...
    // Переиспользуем готовый пул анимаций белки целиком — те же файлы,
    // retargeting делает сам Three.js по именам костей, отдельно
    // копировать/перезаписывать эти клипы под нового персонажа не нужно.
    animationFiles: CHARACTERS.squirrel.animationFiles,
  };
