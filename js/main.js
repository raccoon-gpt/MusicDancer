...
diagnosticRedBgEl.style.top = "0";
diagnosticRedBgEl.style.left = "0";
diagnosticRedBgEl.style.width = "100%";
diagnosticRedBgEl.style.height = "100%";
...
videoBgFileInput.addEventListener("change", () => {
  ...
  videoBgEl.style.width = "100%";
  videoBgEl.style.height = "100%";
