...
function renderCharacterStack() {
  ...
  activeCharacterIds.forEach((id, index) => {
    ...
    if (config.allowCustomDances) {
      ...
      addDanceBtn.className = "dance-toggle-btn";
      ...
      deleteCharBtn.className = "dance-toggle-btn";
      deleteCharBtn.textContent = "✕";
      deleteCharBtn.title = "Remove this character";
      deleteCharBtn.addEventListener("click", () => deleteCustomCharacter(id));
...
(async function initCharacters() {
  const restored = await restoreCustomCharacter();
  if (restored) activeCharacterIds = ["custom"];
  applyActiveCharacters();
})();
