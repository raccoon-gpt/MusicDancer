...
// container и camera нужны новому слою "лучей" вокруг дискошара (2D
// canvas поверх сцены, см. createBallRays в discoLights.js) — раньше
// модулю хватало одной сцены, потому что весь диско-свет был честными
// 3D-объектами.
...
function renderLoop() {
  ...
  discoLights.update(delta, intensityThisFrame, strongBeatThisFrame, beatStrengthThisFrame);
