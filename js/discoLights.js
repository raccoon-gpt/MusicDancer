...
function createDiscoBall(scene) {
  ...
  const material = new THREE.MeshStandardMaterial({
    color: 0xd8d8d8,
    // Металличность — 0.95 (близко к "чистому металлу"). Пробовали
    // снижать до 0.6, рассчитывая на более заметный отклик от прямого
    // света без карты окружения — по факту решили, что чёрный вид
    // (характерный для металла без env map) нравится больше, чем более
    // светлый глянцевый вариант. Вернули обратно.
    metalness: 0.95,
    roughness: 0.18,
