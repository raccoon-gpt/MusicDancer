...
export function createDiscoLights(scene) {
  ...
  // 95% (обычный удар), 91% (сильный удар). Никаких других чисел, кроме
  ...
  const BALL_PULSE_LEVEL_STRONG = 0.91; // цель на сильном ударе
  // Сколько секунд после удара держим цель внизу (95% или 91%), прежде
  ...
  // темп перехода что для 95%, что для 91%, что для возврата к 100%.
   ...
   * @param {boolean} ballStrongBeat - сильный удар из ТОГО ЖЕ выбранного источника, что и ballBeat — переключает цель пульсации шара на 91% (приоритетнее ballBeat в тот же кадр)
   */
